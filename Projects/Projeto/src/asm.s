...
; R8 armazena a quantidade de dígitos tem o número
; R7 armazena o operador
; R12 armazena o primeiro operando
; R6 armazena o segundo operando  
...
;----------
;tx: transmite dados pela serial

tx:
        ;LDR R2, R1          //ponteiro para a primeira posição da string
...
wtx:    LDR R3, [R0, #UART_FR] ; status da UART
        ...
        ;LDR R1, [R1]
        STR R2, [R0] ; escreve no registrador de dados da UART0 (transmite)
        ;BNE wtx
